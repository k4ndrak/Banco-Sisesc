...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_cursos` (
  ...
  PRIMARY KEY (`id_curso`),
    ...
    REFERENCES `sistema_escola`.`tbl_colegiado` (`id_colegiado`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
;
...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_turmas` (
  ...
  PRIMARY KEY (`id_turma`),
    ...
    REFERENCES `sistema_escola`.`tbl_cursos` (`id_curso`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
;
...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_aluno` (
  ...
  PRIMARY KEY (`id_aluno`),
    ...
    REFERENCES `sistema_escola`.`tbl_turmas` (`id_turma`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
    FOREIGN KEY (`fk_user_aluno`)
    REFERENCES `sistema_escola`.`tbl_user` (`id_user`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
;
...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_aluno_disc` (
  ...
  PRIMARY KEY (`id_aluno_disc`),
    ...
    REFERENCES `sistema_escola`.`tbl_aluno` (`id_aluno`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
    FOREIGN KEY (`fk_dicsc`)
    REFERENCES `sistema_escola`.`tbl_disciplina` (`id_disciplina`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
;
...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_cidades` (
  ...
  PRIMARY KEY (`CID_ID`),
    FOREIGN KEY (`UF_ID_FK`)
    REFERENCES `sistema_escola`.`tbl_uf` (`UF_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
;
...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_bairros` (
  ...
  PRIMARY KEY (`BRRS_ID`),
    FOREIGN KEY (`CID_ID_FK`)
    REFERENCES `sistema_escola`.`tbl_cidades` (`CID_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
;
...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_professor` (
  ...
  PRIMARY KEY (`id_prof`),
    ...
    REFERENCES `sistema_escola`.`tbl_funcionario` (`id_funcionario`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
;
...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_prof_disc` (
  ...
  PRIMARY KEY (`id_prof_disc`),
    ...
    REFERENCES `sistema_escola`.`tbl_professor` (`id_prof`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
;
...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_disc_semestre` (
  ...
  PRIMARY KEY (`id`),
    ...
    REFERENCES `sistema_escola`.`tbl_prof_disc` (`id_prof_disc`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_disc_hist` (
  ...
  PRIMARY KEY (`id_disc_hist`),
    ...
    ON UPDATE CASCADE,
    FOREIGN KEY (`fk_hist`)
    REFERENCES `sistema_escola`.`tbl_historico` (`id_historico`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
;
...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_rua` (
  ...
  PRIMARY KEY (`id_rua`),
    ...
    REFERENCES `sistema_escola`.`tbl_bairros` (`BRRS_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    FOREIGN KEY (`fk_logradouro`)
    REFERENCES `sistema_escola`.`tbl_logradouro` (`LOGRAD_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    FOREIGN KEY (`fk_cep`)
    REFERENCES `sistema_escola`.`tbl_cep` (`id_cep`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
;
...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_end` (
  ...
  PRIMARY KEY (`id_end`),  
    ...
    ON UPDATE CASCADE,
    FOREIGN KEY (`fk_rua`)
    REFERENCES `sistema_escola`.`tbl_rua` (`id_rua`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
;
...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_tel_user` (
  ...
  PRIMARY KEY (`id_tel_user`),
    ...
    REFERENCES `sistema_escola`.`tbl_tipo_tel` (`id_tipo_tel`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_nota_disciplina` (
  `id_disc_hist_nota` INT NOT NULL,
  `nota` DOUBLE NOT NULL,
  `fk_disc_hist` INT NOT NULL,
  PRIMARY KEY (`id_disc_hist_nota`),
    FOREIGN KEY (`fk_disc_hist`)
    REFERENCES `sistema_escola`.`tbl_disc_hist` (`id_disc_hist`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
;
...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_formacao_funcionario` (
  `id_formacao_funcionario` INT NOT NULL,
  `fk_funcionario` INT NOT NULL,
  `fk_nivel_formacao` INT NOT NULL,
  `fk_nome_formacao` INT NOT NULL,
  PRIMARY KEY (`id_formacao_funcionario`),
    FOREIGN KEY (`fk_funcionario`)
    REFERENCES `sistema_escola`.`tbl_funcionario` (`id_funcionario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    FOREIGN KEY (`fk_nivel_formacao`)
    REFERENCES `sistema_escola`.`tbl_nivel_formacao` (`id_graduacao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    FOREIGN KEY (`fk_nome_formacao`)
    REFERENCES `sistema_escola`.`tbl_nome_formacao` (`id_nome_formacao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
;
...
CREATE TABLE IF NOT EXISTS `sistema_escola`.`tbl_frequencia_disciplina` (
  `id_frequencia_disciplina` INT NOT NULL AUTO_INCREMENT,
  `frequencia` TINYINT NOT NULL,
  `fk_disc_hist` INT NOT NULL,
  PRIMARY KEY (`id_frequencia_disciplina`),
    FOREIGN KEY (`fk_disc_hist`)
    REFERENCES `sistema_escola`.`tbl_disc_hist` (`id_disc_hist`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
